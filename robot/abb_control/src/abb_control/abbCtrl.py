...
class abbRobot:
    ...
    def __init__(self):
        ...
        self.client = act.SimpleActionClient(
            'joint_trajectory_action', trajAction)
    ...
    def move2Point(self, points, eAngles=[[0, 0, 0]], ax='sxyz', maxVelocityFactor=1, end_effector='link_6'):
        """
    ...
    def cartesian2Point(self, points, eAngles, ax='sxyz', resolution=0.01, jumpStep=0, maxVelocityFactor=1, end_effector='link_6'):
        """
    ...
    def __displayDuration(t1, t2):
        ...
        rp.loginfo(
            "Execution took [min:sec.ms]: %i:%02i.%03i ", spent[0], spent[1], spent[2])
...
def jointsInfo(printoutRate=0.5, anonym=False):
    ...
    listener = rp.Subscriber(
        "/joint_states", JointState, __listenCb, tfListener)
